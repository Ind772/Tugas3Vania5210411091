...
import 'package:tugas_vania_indra/app/models/orderitems.dart';
...
class OrderitemsController extends Controller {
  ...
  Future<Response> create(Request request) async {
    try {
      ...
      return Response.json(
        {"error": "Gagal membuat order item", "details": e.toString()},
      );
    }
  }
    ...
    try {
      ...
      if (orderItem == 0) {
        return Response.json({
          ...
          "message": "Order item dengan $id tidak ditemukan"
        });
      }
